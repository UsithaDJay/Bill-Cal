...
Future<String> generatePdf(
  ...
  String calculationBlk6,
  String calculationBlk7,
  String calculationBlk8,
  String calculationBlk9,
  String calculationBlk10,
  double rateBlk1,
  double rateBlk2,
  double rateBlk3,
  double rateBlk4,
    ...
    children: [
      ...
      pw.TableRow(
        children: [pw.Container(
            ...
            alignment: Alignment.center,
            child: 
          pw.Text('Total Without Tax',
              style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),),
          pw.Text('Rs. ${totalWithoutTax.toStringAsFixed(2)}'),
        ],
      ),
      pw.TableRow(
        children: [pw.Container(
        ...
        return pw.Container(
          ...
          child: pw.Column(
            children: [
              ...
              pw.Container(child: table1, padding: const pw.EdgeInsets.only(
